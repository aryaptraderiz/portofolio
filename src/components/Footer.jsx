    ...
    <div className="mt-32 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <div className="flex gap-3 order-2 md:order-none">
          <a href="https://github.com/aryaptraderiz"><i className="ri-github-fill ri-2x"></i></a>
          <a href="https://www.instagram.com/aryaptraderiz?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==/"><i className="ri-instagram-fill ri-2x"></i></a>
          <a href="https://www.youtube.com/@Aryaptraderiz"><i className="ri-youtube-fill ri-2x"></i></a>
          <a href="https://x.com/aryaptraderiz"><i className="ri-twitter-fill ri-2x"></i></a>
          <a href="https://www.tiktok.com/@aryaputrade"><i className="ri-tiktok-fill ri-2x"></i></a>
          <a href="https://www.tiktok.com/@aryaputrade"><i className="ri-linkedin-fill ri-2x"></i></a>
          <a href="mailto:aryaputraderiz@gmail.com"><i className="ri-mail-fill ri-2x"></i></a>
          <a href="https://wa.me/6287889873718"><i className="ri-whatsapp-fill ri-2x"></i></a>
        </div>
